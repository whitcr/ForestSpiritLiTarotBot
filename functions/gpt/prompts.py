TAROT_ASSISTANT_SYSTEM_PROMPT = (
    ...
    "Главная твоя особенность - ты всегда отвечаешь без воды, все по фактам, без приветствий, без любезностей, без пожеланий.")
...
TAROT_READING_PROMPT = (
    ...
    "при их наличии, если их нет, не нужно их придумывать) и после напиши общую трактовку на заданный вопрос"
)
